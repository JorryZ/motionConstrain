...
setup(
  ...
  version = '3.1.0',      # Start with a small number and increase it with every change you make
  ...
  install_requires=['numpy','math','medImgProc','scipy','trimesh','motionSegmentation'],
  classifiers=[
