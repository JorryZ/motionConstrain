...
setup(
  ...
  version = 'T4.0.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JorryZ/motionConstrain/archive/vt4.0.0.tar.gz',    # I explain this later on
