...
setup(
  ...
  version = '4.2.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JorryZ/motionConstrain/archive/v4.2.0.tar.gz',    # I explain this later on
